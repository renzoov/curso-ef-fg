...
namespace EFCorePeliculas.Migrations
{
    ...
    [Migration("20230928051558_FuncionesDefinidasPorElUsuario")]
            ...
            modelBuilder.Entity("EFCorePeliculas.Entidades.Cine", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Nombre = "Ágora",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-69.9388777 18.4839232)")
                        },
                        new
                        {
                            Id = 2,
                            Nombre = "Sambil",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-69.9118801 18.482621)")
                        },
                        new
                        {
                            Id = 3,
                            Nombre = "Megacentro",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-69.856089 18.506934)")
                        },
                        new
                        {
                            Id = 4,
                            Nombre = "Acropolis",
                            Ubicacion = (NetTopologySuite.Geometries.Point)new NetTopologySuite.IO.WKTReader().Read("SRID=4326;POINT (-69.942166 18.482787)")
                        });
                });
            ...
            modelBuilder.Entity("EFCorePeliculas.Entidades.CineOferta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CineId = 1,
                            FechaFin = new DateTime(2023, 10, 28, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2023, 9, 28, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("EFCorePeliculas.Entidades.Mensaje", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 2,
                            Contenido = "Hola Felipe, ¿Cómo estas?",
                            EmisorId = 2,
                            ReceptorId = 1
                        },
                        new
            ...
            modelBuilder.Entity("EFCorePeliculas.Entidades.Pelicula", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 2,
                            EnCartelera = false,
                            FechaEstreno = new DateTime(2017, 10, 22, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        new
                        {
                            Id = 5,
                            EnCartelera = true,
                            FechaEstreno = new DateTime(2023, 9, 28, 0, 0, 0, 0, DateTimeKind.Local),
